                ...
                {tasks.slice(0, 3).map((task: Task, i: number) => (
                  <>
                    <button
                      ...
                      className={
                        'py-auto text-md mx-5 mt-2 rounded border border-gray-700 bg-gray-800 p-4 text-center font-bold text-white outline-none ring-white ring-offset-2 ring-offset-black drop-shadow-sm focus:z-10 focus:ring md:mx-auto md:max-w-sm md:p-5 ' +
